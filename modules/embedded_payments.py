...
def run_embedded_payments():
    ...
    st.subheader("🛡 Insurance Suggestion")import streamlit as st
import json
import random
...
def run_embedded_payments():
    ...
    if segment == "High Net Worth":
        ...
        reason = "You are classified as a High Net Worth client based on income, product holdings, and vehicle ownership. Orient offers premium service quality."
    elif segment == "Affluent":
        recommended = "Orient Insurance"
        reason = "As an Affluent segment client, you would benefit from balanced coverage and faster claims via Orient."
    else:
        recommended = "Noor Takaful"
        reason = "As a cost-conscious Mass segment client, Noor Takaful offers a better value for essential coverage."
